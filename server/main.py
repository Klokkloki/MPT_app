...
async def get_content_advertisements():
    ...
    advertisements = [
        ...
        },
        {
            "id": "tg-2", 
            "title": "ТКГ МПТ",
            "subtitle": "Официальный канал с новостями и событиями в ТКГ МПТ",
            "description": "Официальный канал с новостями и событиями в ТКГ МПТ для студентов и преподавателей. Подписывайся, чтобы не пропустить важные события и новости. А также получай полезные советы и рекомендации для студенческой жизни.",
            "iconEmoji": "💻",
